...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i11.RemoteDogImagesBloc>(
        () => _i11.RemoteDogImagesBloc(gh<_i10.GetDogImagesUseCase>()));
    gh.factory<_i12.SaveDogImageUseCase>(
        () => _i12.SaveDogImageUseCase(gh<_i7.DataRepository>()));
    gh.factory<_i13.ClearDogImagesUseCase>(
        () => _i13.ClearDogImagesUseCase(gh<_i7.DataRepository>()));
    gh.factory<_i14.LocalDogImagesBloc>(() => _i14.LocalDogImagesBloc(
          gh<_i10.GetDogImagesUseCase>(),
          gh<_i12.SaveDogImageUseCase>(),
          gh<_i9.DeleteDogImageUseCase>(),
          gh<_i13.ClearDogImagesUseCase>(),
        ));
    return this;
  }
}
